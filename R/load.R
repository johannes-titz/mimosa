...
load_data <- function(name, datapath) {
  ...
  switch(ext,
    ...
    validate("Sorry, I could not read your data. Please check that it is in the SPSS format .sav or a regular .csv file with a comma or a semicolon as the separator.")
  )
}
