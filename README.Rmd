...
selected dependent variable has exactly two observed values; other numeric
responses use a Gaussian linear mixed model. For a dichotomous response, the
second factor level (or the second value in sorted order) is modeled as the
event, and Mimosa states this coding above the output.
